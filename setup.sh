...
if [ $? -eq 0 ]; then
    ...
    echo "  python3 stock_predictor.py AAPL 2026-03-15"
    echo "  python3 stock_predictor.py TSLA 2026-04-01 --days 730"
    echo ""
    echo "Or try demo mode:"
    echo "  python3 stock_predictor.py --demo"
    echo ""
    echo "Or run interactive examples:"
    echo "  python3 test_predictor.py"
    echo ""
else
    echo ""
    echo "================================================"
